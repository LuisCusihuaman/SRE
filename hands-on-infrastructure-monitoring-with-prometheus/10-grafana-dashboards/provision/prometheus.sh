...
install -m 0644 -D -t /usr/share/prometheus/consoles /vagrant/10-grafana-dashboards/configs/prometheus/grafana.html
...
install -m 0644 /vagrant/10-grafana-dashboards/configs/prometheus/prometheus.service /etc/systemd/system/
install -m 0644 -D /vagrant/10-grafana-dashboards/configs/prometheus/prometheus.yml /etc/prometheus/prometheus.yml
